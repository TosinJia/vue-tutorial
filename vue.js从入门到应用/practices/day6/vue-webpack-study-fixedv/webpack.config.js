...
module.exports = {
    ...
    module: {   // 用来配置 非JS文件对应的loader的
        rules: [    // 就是这些 非 JS 文件 和 loader 之间的对应关系
            {test: /\.css$/, use: ['style-loader', 'css-loader']},   // 创建处理 css 文件的 loader 匹配规则，从后到前调用
            ...
            {test:/\.ttf|woff2|woff|eot|svg$/, use:'url-loader'}// 处理 样式中字体文件路径的问题
        ]
    },
    resolve: {  //vue.js 方式二
        alias: {    // node_modules/vue/dist/vue.js
            'vue$': 'vue/dist/vue.js'   
        }
    },
}