...
// ES6 中的新语法， 是ES6中实现面向对象编程的新方式
// webpack 3.10.0 默认只能帮我们打包并处理一小部分的ES6新特性，但是无法处理所有的ES6及ES7+新特性，
// 在 React 中，class 关键字，是专门用来创建React组件的
class Person{
    // 静态的属性
    static info = {name: 'tosin'}
}
console.log("Person.info", Person.info);   //webpack 5.64.4可以
...
//     this.age = age;
// }
// console.log(new Per('tosin', 18));

const d = "const d";
import m2, {d as dd, c} from './js/01.导入和导出.js'
console.log("import m2, {c, d as dd} from './js/01.导入和导出.js'", m2, c, dd, d);
